...
export function Nav(){
    return(
        <nav className=" rounded-t-none lg:rounded-t-lg shadow-lg w-nav w-screen fixed flex items-center justify-evenly lg:mt-[25px] lg:mx-[25px] p-2 backdrop-blur bg-[#F9E8D9] rounded-lg text-orange-500">
            <Logo/>
